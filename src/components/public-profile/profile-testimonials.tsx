  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 mb-6">
        ...
        <h2 id="testimonials-heading" className="text-2xl font-bold text-slate-900">Témoignages</h2>
      </div>
