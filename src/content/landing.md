...
stats:
  - value: "500+"
    label: "Photographes professionnels"
  - value: "12 000+"
    label: "Galeries photo livrées"
  - value: "150K+"
    label: "Photos haute résolution"
  - value: "4.9/5"
    label: "Note moyenne"
...
testimonials:
  ...
  title: "Ce qu'ils disaient avant de tester"
  subtitle: "\"WhatsApp c'est plus simple\", \"Mes clients n'y arriveront pas\", \"Ça marche bien comme ça\""
  items:
    ...
    - name: "Grace Kabongo"
      ...
      content: "Mes clients utilisent mes photos pour leurs profils et sites web. Avec WhatsApp, c'était pixelisé. Maintenant ils téléchargent en HD et me recommandent à leurs collègues."
      avatar: "GK"
    - name: "David Tshimanga"
      role: "Photographe événementiel • Goma"
      content: "Je shootais des événements et j'envoyais 200 photos par WhatsApp. C'était le chaos. Maintenant : un lien, une galerie propre, mes clients téléchargent ce qu'ils veulent en qualité max."
      avatar: "DT"

pricing:
  badge: "Tarifs transparents"
  title: "Commencez gratuitement."
  titleLine2: "Évoluez quand vous êtes prêt."
  subtitle: "Pas d'engagement. Pas de surprise. Annulez en 1 clic."
  guarantee: "Paiement sécurisé • Satisfait ou remboursé 30 jours • Annulation en 1 clic"
...
plans:
  ...
  - name: "Premium"
    price: "$9.99"
    period: "/mois"
    description: "Le choix de 80% des photographes"
    popular: true
  ...
  - name: "Pro"
    ...
    cta: "Passer à Pro"
    features:
      - "500 galeries actives"
      - "5000 photos par galerie"
      - "50 Go de stockage"
      - "Expiration jusqu'à 180 jours"
