/**
 * Gallery Download by Slug API Route
 * GET - Download all gallery images as ZIP (public access)
 * 
 * @module app/api/galleries/download/[slug]/route
 */
...
/**
 * GET /api/galleries/download/[slug]
 * Download all images from a gallery as a ZIP file (public access via slug)
 */
