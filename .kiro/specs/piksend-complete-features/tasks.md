...
- [ ] 1. Fondations: Types et Configuration des Plans
  - [ ] 1.1 Étendre les types TypeScript avec les nouvelles interfaces
  ...
  - [ ] 1.2 Créer le système de vérification des fonctionnalités par plan
  ...
  - [ ]* 1.3 Écrire les tests de propriété pour l'accès aux fonctionnalités par plan
    - **Property 1: Plan-Based Feature Access**
    - **Validates: Requirements 1.4.6, 3.1.5, 3.2.5, etc.**

- [ ] 2. Migration Base de Données
  - [ ] 2.1 Créer la migration pour les nouvelles tables
...
- [ ] 4. Services Backend: Engagement & Feedback
  - [ ] 4.1 Créer le service Favorites
  ...
  - [ ]* 4.2 Écrire les tests de propriété pour Favorites
    - **Property 13: Favorites Toggle Idempotence**
    - **Validates: Requirements 3.1.2**
  - [ ] 4.3 Créer le service Comments
  ...
  - [ ] 4.4 Créer le service Analytics
...
- [ ] 5. Services Backend: Monétisation
  - [ ] 5.1 Étendre le service Payment pour le Paywall
...
- [ ] 6. Services Backend: Anti-Ghosting
  ...
  - [ ]* 6.3 Écrire les tests de propriété pour QR Code round-trip
...
- [ ] 10. Composants Frontend: Galerie Améliorée
  ...
  - [ ]* 10.4 Écrire les tests pour la navigation Lightbox
    - **Property 4: Lightbox Keyboard Navigation**
    - **Validates: Requirements 1.2.2**

- [ ] 11. Composants Frontend: Anti-Ghosting
  - [ ] 11.1 Créer le composant DeadlineTimer
...
- [ ] 13. Composants Frontend: Branding
  - [ ] 13.1 Créer le composant ColorPicker
    - Créer `src/components/settings/color-picker.tsx`
    - Support hex et presets
    - _Requirements: 5.3.4_
  - [ ] 13.2 Créer la section BrandingSettings
...
- [ ] 15. Intégration Page Galerie Publique
  ...
  - [ ] 15.2 Implémenter le gating par plan
...
- [ ] 16. Dashboard Photographe: Settings Galerie
  - [ ] 16.1 Étendre SettingsTab avec nouvelles options
...
- [ ] 17. Dashboard Photographe: Analytics
  - [ ] 17.1 Créer la page Analytics
  ...
  - [ ] 17.2 Créer les composants de visualisation
    - Graphiques avec recharts ou chart.js
    - Carte des pays
    - _Requirements: 3.3.3_

- [ ] 18. Checkpoint - Vérifier le dashboard
